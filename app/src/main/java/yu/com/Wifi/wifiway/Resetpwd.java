...
//                    resetpwd_check();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPwd_old.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
        mPwd_new = (EditText) findViewById(R.id.resetpwd_edit_pwd_new);
        mPwd_new.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
...
//                    Toast.makeText(Resetpwd.this, "密码输入不一致！", Toast.LENGTH_SHORT).show();
//                } else {
...
//                Toast.makeText(Resetpwd.this, "用户名和密码不匹配！", Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
...
//        //用户不存在时返回，给出提示文字
//        if (count <= 0) {
//            Toast.makeText(Resetpwd.this, "手机号不存在！", Toast.LENGTH_SHORT).show();
//            return false;
//        }
...
//            Toast.makeText(Resetpwd.this, "请输入旧密码！", Toast.LENGTH_SHORT).show();
//            return false;
//        } else if (mPwd_new.getText().toString().trim().equals("")) {
//            Toast.makeText(Resetpwd.this, "请输入新密码！", Toast.LENGTH_SHORT).show();
//            return false;
//        } else if (mPwdCheck.getText().toString().trim().equals("")) {
//            Toast.makeText(Resetpwd.this, "请输入确认密码！", Toast.LENGTH_SHORT).show();
//            return false;
//        }
//        return true;
//    }
